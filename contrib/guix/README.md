# Bootstrappable Kiirocoin Core Builds

This directory contains the files necessary to perform bootstrappable Kiirocoin
Core builds.
...
To build Kiirocoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Kiirocoin Core version being built.
