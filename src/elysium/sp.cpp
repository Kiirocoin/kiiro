...
CMPSPInfo::CMPSPInfo(const boost::filesystem::path& path, bool fWipe)
{
    ...
    implied_elysium.url = "https://www.kiirocoin.org";
    implied_elysium.data = "Exodus serve as the binding between Kiirocoin, smart properties and contracts created on the Exodus Layer.";
    ...
    implied_telysium.url = "https://www.kiirocoin.org";
    implied_telysium.data = "Test Exodus serve as the binding between Kiirocoin, smart properties and contracts created on the Exodus Layer.";
        ...
        std::pair<int64_t, int64_t>& tokens, bool& close_crowdsale)
{
    ...
    // Precision for all non-kiirocoin values (bonus percentages, for example)
    ...
    // Precision for kiirocoin amounts (satoshi)
