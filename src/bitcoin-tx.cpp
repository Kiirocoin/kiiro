...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kiirocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kiirocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Kiirocoin transaction") + "\n" +
              "  kiirocoin-tx [options] -create [commands]   " + _("Create hex-encoded Kiirocoin transaction") + "\n" +
              "\n";
