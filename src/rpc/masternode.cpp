...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the znode owner Kiirocoin address\n"
            "  payee          - Print the znode payout Kiirocoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the znode operator public key\n"
            "  status         - Print znode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the znode voting Kiirocoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "kiirocoin",               "znode",                 &masternode,             true,  {} },
    { "kiirocoin",               "znodelist",             &masternodelist,         true,  {} },
    { "kiirocoin",               "evoznode",              &masternode,             true,  {} },
    { "kiirocoin",               "evoznodelist",          &masternodelist,         true,  {} },
};
