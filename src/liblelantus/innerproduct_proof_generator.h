#ifndef KIIRO_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
#define KIIRO_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
...
#endif //KIIRO_LIBLELANTUS_INNERP_RODUCT_PROOF_GENERATOR_H
