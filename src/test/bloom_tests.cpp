...
{
    std::string strSecret = bitcoin_address_to_kiirocoin(std::string("5Kg1gnAjaLfKiwhhPpGS3QfRg2m6awQvaj98JCZBZQ5SuS2F15C"));
...
{
    // Random real block (000000000000dab0130bbcc991d3d7ae6b81aa6f50a798201dfe62337458dc45)
    // With one tx
    CBlock block;
