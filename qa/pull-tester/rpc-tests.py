...
#Set env vars
if "KIIROD" not in os.environ:
    os.environ["KIIROD"] = BUILDDIR + '/src/kiirocoind' + EXEEXT
if "KIIROCLI" not in os.environ:
    os.environ["KIIROCLI"] = BUILDDIR + '/src/kiirocoin-cli' + EXEEXT
