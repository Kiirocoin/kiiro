...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # This will raise an exception for attempting to get the private key of an Invalid Kiirocoin address
        otp = self.get_otp("invalid")
        assert_raises_jsonrpc(-5, "Invalid Kiirocoin address", self.nodes[0].dumpprivkey, "invalid", otp)

        # # This will raise an exception for attempting to set a label for an Invalid Kiirocoin address
        # assert_raises_jsonrpc(-5, "Invalid Kiirocoin address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_jsonrpc(-5, "Invalid Kiirocoin address or script", self.nodes[0].importaddress, "invalid")
