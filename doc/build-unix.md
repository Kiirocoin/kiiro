...
The instructions below describe how to manually build Kiirocoin with system level or
...
Note
---------------------
Always use absolute paths to configure and compile Kiirocoin and the dependencies,
...
This will build kiirocoin-qt as well if the dependencies are met.
...
If you want to build Kiirocoin-Qt, make sure that the required packages for Qt development
are installed.
...
Once these are installed, they will be found by configure and a kiirocoin-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip kiirocoind" to strip the debug
...
Security
--------
To help make your Kiirocoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Kiirocoin should be built with a non-executable stack
